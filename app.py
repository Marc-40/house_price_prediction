...
linear_model = joblib.load('lr.pkl')
scaler = joblib.load('sclr.pkl')
...
# Define the luxury vs affordable threshold
price_threshold = 500000  # Adjust this value as needed
...
if st.button("Predict"):
    ...
    # Categorize the house as 'luxury' or 'affordable'
    category = "Luxury" if predicted_price[0] > price_threshold else "Affordable"
    st.subheader(f"Category: {category}")
    if category == "Luxury":
        st.info("This house falls into the **Luxury** category.")
    else:
        st.info("This house falls into the **Affordable** category.")
